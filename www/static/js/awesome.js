...
function CreateArticleCategory() {
    $("#rootul").append("<li id='li0'></li>")
    $('#li0').append("<a style=\"font-size:16px; \" href=\"#\" data-uk-smooth-scroll=\"{offset: 50}\">"+document.title+"</a>")
    $('#li0').append("<ul class=\"uk-nav uk-nav-side ul-none\" id=\"ul0\"></ul>")
    fatherulID = "#ul0"
    ...
    $(".uk-article").children().each(function (index, element) {
        ...
        var object_a = "<a style=\"font-size:16px; \" href='#" + hID + "' data-uk-smooth-scroll=\"{offset: 50}\">" + contentH + "</a>";
        var object_li = "<li style=\"color:#fff; font-size:14px;\" class='li" + tagName.substr(1, 1) + "' id='" + liid + "'></li>";
        var object_ul = "<ul  class='uk-nav uk-nav-side ul-none' id='" + ulid + "'></ul>";
